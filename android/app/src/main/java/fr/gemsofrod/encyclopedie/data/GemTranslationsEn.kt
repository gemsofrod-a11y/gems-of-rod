...
/** Traductions anglaises du nom et des textes descriptifs des gemmes. */
object GemTranslationsEn {
    val data: Map<String, GemTranslation> = mapOf(
        ...
        "eudialyte" to GemTranslation(
            nom = "Eudialyte",
            descriptionCourte = "Raspberry-red patches in a grey matrix, nicknamed the \"drunkard's stone\".",
            descriptionLongue = "Eudialyte forms raspberry-red to pink patches and veins in a grey alkaline rock (often associated with nepheline), earning it the nickname \"drunkard's stone\" in Russia. Rarely faceted in pure form, it is mainly used as cabochons or tumbled stones.",
            particularites = "Almost always sold as a cabochon or rough-polished stone, rarely faceted due to its partial opacity.",
            lithotherapie = "Nicknamed the stone of self-love, eudialyte is used to soothe emotional wounds and foster self-acceptance."
        ),
        ...
        "malachite" to GemTranslation(
            nom = "Malachite",
            descriptionCourte = "The emblematic green of copper, in concentric bands.",
            descriptionLongue = "Malachite forms botryoidal masses with concentric bands of light to dark green, colored by copper. Used since ancient Egypt as a pigment and ornamental stone, it adorns both jewelry and furnishings (the Kremlin's columns).",
            particularites = "Always cut as a cabochon or polished object; never faceted due to its softness and opacity.",
            lithotherapie = "A stone of transformation, malachite is said to absorb negative energies and gently support life changes."
        ),
        ...
        "seraphinite" to GemTranslation(
            nom = "Seraphinite",
            descriptionCourte = "A deep green crossed with silky silver feathers.",
            descriptionLongue = "Seraphinite, the trade name for a clinochlore variety, displays feathery silver patterns on a dark green background, evoking angel wings — hence its name. Always worked as a polished cabochon to reveal this silky sheen.",
            particularites = "Extremely soft: best reserved for jewelry with little exposure to impact (pendants, earrings).",
            lithotherapie = "A stone of deep healing, seraphinite is said to help release repetitive patterns and initiate inner renewal."
        ),
        "grenat-grossulaire" to GemTranslation(
            nom = "Grossular garnet",
        ...
        "maw-sit-sit" to GemTranslation(
            nom = "Maw-sit-sit",
            descriptionCourte = "An electric green veined with black, named after a Burmese village.",
            descriptionLongue = "Maw-sit-sit, named after the Burmese village where it was discovered in 1963, is a rock dominated by jadeite and kosmochlor (a chromium-bearing pyroxene) offering a vivid green crossed with black veins, highly prized in Asia.",
            particularites = "The only known deposit in the world to date, located near the Hpakant jadeite mines.",
            lithotherapie = "Maw-sit-sit is associated with renewal and the flow of positive energy during times of transition."
        ),
        "tourmaline-chrome" to GemTranslation(
            nom = "Chrome tourmaline",
        ...
        "variscite" to GemTranslation(
            nom = "Variscite",
            descriptionCourte = "Translucent apple green, a cousin of turquoise.",
            descriptionLongue = "An aluminum phosphate chemically related to turquoise, variscite displays a veined apple green to emerald green, often crossed by fine white veins of crandallite. Cut as cabochons, it remains a niche presence on the market.",
            particularites = "Often mistaken for turquoise; always cut as a cabochon.",
            lithotherapie = "Variscite is associated with emotional balance, bringing a sense of comfort and inner security."
        ),
        "serpentine" to GemTranslation(
            nom = "Serpentine (bowenite)",
            descriptionCourte = "An accessible alternative to jade.",
            descriptionLongue = "Bowenite, a compact and hard variety of serpentine, has been used as a substitute for nephrite jade since antiquity in New Zealand (pounamu) and China. Its translucent green and toughness make it a prized ornamental stone.",
            particularites = "The bowenite variety, harder and more translucent, is the most sought after for jewelry.",
            lithotherapie = "Serpentine is believed to promote renewal and grounding, a support during periods of personal rebuilding."
        ),
        ...
        "azurite" to GemTranslation(
            nom = "Azurite",
            descriptionCourte = "The deep blue of copper, often intergrown with malachite.",
            descriptionLongue = "Azurite forms crystals and masses of intense deep blue, colored by copper. Unstable over the long term (it can transform into malachite on contact with moisture), it is mainly worked into cabochons or decorative objects, often paired with green malachite.",
            particularites = "Can gradually alter into malachite (pseudomorphosis); should be protected from humidity and direct light.",
            lithotherapie = "Azurite is believed to stimulate intuition and mental clarity, a support for reflection and decision-making."
        ),
        "sodalite" to GemTranslation(
            nom = "Sodalite",
            descriptionCourte = "A deep blue veined with white, often mistaken for lapis lazuli.",
            descriptionLongue = "Sodalite offers a royal blue veined with white calcite, similar to lapis lazuli but without pyrite's golden inclusions. It has been used for cabochons, inlay work, and decorative objects since its discovery in Greenland in the 19th century.",
            particularites = "Distinguished from lapis lazuli by the absence of golden pyrite flecks and a lower density.",
            lithotherapie = "Sodalite is associated with clear communication and logic, while easing mental anxiety."
        ),
        "larimar" to GemTranslation(
            nom = "Larimar",
            descriptionCourte = "The unique Caribbean blue of a pectolite found on a single island.",
            descriptionLongue = "Larimar is a variety of pectolite in turquoise blue to sky blue, evoking the waters of the Caribbean, its color coming from traces of copper. A nearly unique deposit in the Dominican Republic makes it a geographically exclusive gem.",
            particularites = "Nearly exclusive deposit; the name combines \"Larissa\" (the discoverer's daughter) and \"mar\" (sea in Spanish).",
            lithotherapie = "A stone of serenity, larimar is believed to ease stress and facilitate sincere, heartfelt communication."
        ),
        ...
        "tourmaline-bleue" to GemTranslation(
            nom = "Blue tourmaline (indicolite)",
        ...
        "shattuckite" to GemTranslation(
            nom = "Shattuckite",
            descriptionCourte = "A deep, silky blue, a rare cousin of chrysocolla.",
            descriptionLongue = "Shattuckite offers an intense, silky blue in fibrous aggregates, often found alongside chrysocolla and malachite in Namibian copper deposits. Always worked into cabochons to reveal its subtle chatoyance.",
            particularites = "Too soft for faceting; always shaped as a cabochon.",
            lithotherapie = "Shattuckite is believed to strengthen intuition and facilitate more conscious communication with oneself."
        ),
        ...
        "violane" to GemTranslation(
            nom = "Violane",
            descriptionCourte = "A massive, compact variety of diopside, deep blue-violet.",
            descriptionLongue = "Violane is a massive, compact variety of diopside, in a deep blue-violet close to that of some azurites, colored by inclusions of magnetite. Always worked into cabochons or polished objects.",
            particularites = "Its type and historic locality is the Aosta Valley in Italy; always shaped as a cabochon.",
            lithotherapie = "Violane, a violet variety of diopside, is associated with mental calming and introspection, a support for meditation."
        ),
        ...
        "purpurite" to GemTranslation(
            nom = "Purpurite",
            descriptionCourte = "An intense, opaque violet-red, a rare ornamental phosphate stone.",
            descriptionLongue = "Purpurite takes its name from its deep purple color, the result of the alteration of manganese and iron phosphates. Opaque and relatively soft, it is shaped into cabochons for jewelry and art objects.",
            particularites = "Surface color can fade with prolonged light exposure; should be protected.",
            lithotherapie = "Purpurite is associated with personal transformation and inner strength during times of change."
        ),
        ...
        "lepidolite" to GemTranslation(
            nom = "Lepidolite",
            descriptionCourte = "The lilac lithium mica, often associated with pink tourmaline.",
            descriptionLongue = "Lepidolite is a lithium-rich mica with a characteristic lilac to mauve hue, frequently found in pegmatite alongside pink tourmaline and kunzite, with which it shares the same lithium chemistry.",
            particularites = "Too soft and flaky for faceted jewellery; used for cabochons, beads and decorative objects.",
            lithotherapie = "Rich in natural lithium, lepidolite is traditionally credited with soothing stress and anxiety and promoting peaceful sleep."
        ),
        ...
        "sugilite" to GemTranslation(
            nom = "Sugilite",
            descriptionCourte = "Intense purple, popularised in the 1970s.",
            descriptionLongue = "Described in Japan in 1944 and later popularised by South African deposits discovered in the 1970s, sugilite offers a deep opaque-to-translucent violet to purple, cut as cabochons.",
            particularites = "Always cut as cabochons; the main South African deposit is now exhausted.",
            lithotherapie = "Sugilite is reputed to offer spiritual protection and comfort during periods of grief or deep emotional fatigue."
        ),
        ...
        "cobaltocalcite" to GemTranslation(
            nom = "Cobaltocalcite",
            descriptionCourte = "A vivid candy pink, a variety of calcite coloured by cobalt.",
            descriptionLongue = "Cobaltocalcite (cobaltoan calcite) displays an electric bright pink caused by traces of cobalt, forming botryoidal crusts highly prized by collectors. Its extreme softness rules out any regular jewellery use.",
            particularites = "Extremely soft and sensitive to acids like all calcite; a collector's stone exclusively.",
            lithotherapie = "Cobaltocalcite is associated with self-love and tenderness, offering gentle emotional support during sensitive times."
        ),
        "thulite" to GemTranslation(
            nom = "Thulite",
            descriptionCourte = "The pink variety of zoisite, cousin to blue tanzanite.",
            descriptionLongue = "Thulite is the pink to rose-red variety of zoisite, coloured by manganese — the same mineral as tanzanite, but without the heating that reveals the latter's blue-violet colour. Discovered in Norway, it takes its name from Thule.",
            particularites = "Almost always opaque and shaped as cabochons; transparent faceted stones are rare.",
            lithotherapie = "Thulite is reputed to rekindle joy and emotional vitality, offering support for reconnecting with positive emotions."
        ),
        "rhodonite" to GemTranslation(
            nom = "Rhodonite",
            descriptionCourte = "A deep pink veined with manganese black.",
            descriptionLongue = "Rhodonite offers a rich pink to rose-red, crossed by black veins of manganese oxides that give it a characteristic mottled appearance. Russia's national stone, it has historically adorned imperial palaces.",
            particularites = "Russia's national stone; the black manganese veins make for a distinctive identifying pattern.",
            lithotherapie = "Rhodonite is traditionally associated with forgiveness and the healing of emotional wounds, particularly after a breakup."
        ),
        ...
        "rhodochrosite" to GemTranslation(
            nom = "Rhodochrosite",
            descriptionCourte = "Concentric pink and white banding.",
            descriptionLongue = "Recognisable by its concentric pink-and-white patterns reminiscent of tree rings, rhodochrosite is a prized decorative and collector's stone, but too fragile for everyday wear in a ring.",
            particularites = "Very fragile and sensitive to acids; reserved for collector's pieces or protected pendants.",
            lithotherapie = "Rhodochrosite is reputed to foster self-love and the healing of the inner child, offering support in deep emotional work."
        ),
        ...
        "bois-fossilise" to GemTranslation(
            nom = "Fossilized wood",
            descriptionCourte = "Tree wood replaced atom by atom with silica over millions of years.",
            descriptionLongue = "Fossilized wood results from the gradual silicification of buried tree trunks, quartz replacing the organic matter while preserving the original woody structure, growth rings included. Once polished, it reveals striking natural patterns.",
            particularites = "Faithfully preserves the original cellular structure of the wood, sometimes visible under a microscope.",
            lithotherapie = "Fossilized wood is reputed to offer deep grounding and a reminder of the patience needed for any lasting transformation."
        ),
        "os-fossilise" to GemTranslation(
            nom = "Fossilized bone",
            descriptionCourte = "Bones, sometimes from dinosaurs, mineralized and polished into cabochons.",
            descriptionLongue = "Fossilized bone, sometimes derived from genuine dinosaur bones, mineralises as organic apatite is replaced by silica or other minerals, preserving the characteristic porous structure of bone tissue, revealed once polished.",
            particularites = "The original porous cellular structure remains visible once the stone is polished, a signature of fossil bone tissue.",
            lithotherapie = "Associated with grounding and stability, fossilized bone is said to recall the importance of roots and personal memory."
        ),
        ...
        "hyperstene" to GemTranslation(
            nom = "Hypersthene",
            descriptionCourte = "A shimmering bronze-brown, sometimes called \"velvet stone\".",
            descriptionLongue = "Hypersthene displays a characteristic bronze-gold shimmer (schiller) caused by internal lamellar inclusions, earning it the nickname \"velvet stone\". It is most often cut as cabochons to reveal this effect.",
            particularites = "The bronze-gold shimmer effect (schiller) is caused by internal exsolution lamellae.",
            lithotherapie = "Hypersthene is reputed to foster introspection and offer a discreet form of energetic protection."
        ),
        "paesine" to GemTranslation(
            nom = "Paesina",
            descriptionCourte = "A limestone rock whose natural patterns evoke miniature landscapes.",
            descriptionLongue = "Paesina, or \"pietra paesina\" (landscape stone), is a limestone rock in which infiltrations of iron and manganese oxides naturally trace patterns evoking landscapes, ruins or horizons — an entirely natural pictorial phenomenon, prized in Tuscany since the Renaissance.",
            particularites = "Each polished slab is unique, like a natural painting formed by the capillary spread of metal oxides.",
            lithotherapie = "Nicknamed \"landscape stone\", paesina invites contemplation and deep inner calm."
        ),
        ...
        "rutile" to GemTranslation(
            nom = "Rutile",
            descriptionCourte = "The crystal responsible for the golden inclusions in rutilated quartz, rarely faceted on its own.",
            descriptionLongue = "Rutile, a titanium oxide with a metallic luster, is best known as the mineral included within rutilated quartz, but is exceptionally found in crystals pure and transparent enough to be faceted, revealing very high dispersion.",
            particularites = "Very high optical dispersion, close to that of diamond, rarely exploited because of its dark color.",
            lithotherapie = "Rutile is traditionally associated with amplifying energy and bringing clarity in the pursuit of one's goals."
        ),
        ...
        "staurotide" to GemTranslation(
            nom = "Staurolite (fairy cross)",
            descriptionCourte = "Famous for its cross-shaped twins.",
            descriptionLongue = "Staurolite naturally forms cross-shaped twins known as \"cross stones\" or \"fairy crosses,\" traditionally worn as amulets. Rarely faceted due to its frequent opacity, it is mostly collected in its raw, twinned form.",
            particularites = "Characteristic cross-shaped twins; rarely faceted, mostly collected in raw form.",
            lithotherapie = "Nicknamed the cross stone, staurolite is traditionally worn as a talisman for protection and good luck."
        ),
        ...
        "hematite" to GemTranslation(
            nom = "Hematite",
            descriptionCourte = "The metallic gray-black iron oxide, mirror-polished since antiquity.",
            descriptionLongue = "Hematite is cut as a cabochon or intaglio to reveal an almost mirror-like metallic gray-black luster. Used as a seal stone since ancient Egypt, its powder in fact leaves a characteristic red streak — the origin of its name, from the Greek for \"blood.\"",
            particularites = "Its powder (streak) is blood-red despite its black metallic appearance, the origin of its Greek name.",
            lithotherapie = "The grounding stone par excellence, hematite is said to strengthen inner resolve and protect against surrounding negative energies."
        ),
        "magnetite" to GemTranslation(
            nom = "Magnetite",
            descriptionCourte = "The natural magnet of antiquity, known as lodestone.",
            descriptionLongue = "Magnetite is the naturally magnetic mineral par excellence, known since antiquity as \"lodestone.\" Rarely faceted due to its total opacity, it is mostly worked into beads and cabochons.",
        ...
        "onyx" to GemTranslation(
            nom = "Onyx",
            descriptionCourte = "Black and white bands, often dyed.",
            descriptionLongue = "A microcrystalline variety of quartz in the chalcedony family, onyx naturally displays black and white bands. Most stones sold commercially are dyed to achieve a uniform, intense black.",
            particularites = "Artificial dyeing is nearly universal to make the color uniform.",
            lithotherapie = "Onyx is traditionally associated with inner strength, emotional stability, and gentle everyday protection."
        ),
        "spinelle-noir" to GemTranslation(
            nom = "Black spinel",
            descriptionCourte = "Metallic luster for men's jewelry.",
            descriptionLongue = "Opaque and deep black, black spinel is especially prized in contemporary men's jewelry for its almost metallic luster and its durability for everyday wear.",
            particularites = "High scratch resistance, suited to jewelry worn daily.",
            lithotherapie = "Black spinel is said to offer solid energetic protection while promoting grounding."
        ),
        "tourmaline-noire" to GemTranslation(
            nom = "Black tourmaline (Schorl)",
            descriptionCourte = "The most common variety of tourmaline.",
            descriptionLongue = "Rich in iron, schorl is by far the most widespread variety of tourmaline on Earth. Opaque and jet black, it is traditionally associated with protective virtues in lithotherapy.",
            particularites = "Often striated prismatic crystals, sometimes of large size.",
            lithotherapie = "Black tourmaline (schorl) is one of the most renowned protective stones in lithotherapy, believed to absorb negative energies and strengthen grounding."
        ),
        ...
        "pietersite" to GemTranslation(
            nom = "Pietersite",
            descriptionCourte = "A shimmering blue-gold swirl, nicknamed the \"storm eye.\"",
            descriptionLongue = "Pietersite is a quartz containing broken and recemented fibrous crocidolite inclusions, producing a chaotic blue, gold, and brown chatoyance evoking a frozen storm — hence its nickname, the \"storm eye.\" Discovered in Namibia in 1962.",
            particularites = "The chaotic chatoyant pattern, unlike the regular pattern of tiger's eye, results from natural fracturing of the internal fibers.",
            lithotherapie = "Nicknamed the \"storm stone,\" pietersite is said to support courage in the face of rapid, unforeseen change."
        ),
        ...
        "jaspe" to GemTranslation(
            nom = "Jasper",
            descriptionCourte = "An opaque quartz with endless patterns, from blood red to landscape green.",
            descriptionLongue = "Jasper is a microcrystalline aggregate of quartz rendered opaque by numerous mineral impurities, offering an almost limitless palette of colors and patterns. \"Landscape jasper\" mimics entire natural scenes within the polished stone.",
            particularites = "Total opacity unlike agate, due to the density of included mineral impurities.",
            lithotherapie = "Jasper is said to promote grounding and endurance, a support for holding steady through demanding times."
        ),
        ...
        "ammolite" to GemTranslation(
            nom = "Ammolite",
            descriptionCourte = "The frozen iridescence of fossilized ammonite shells.",
            descriptionLongue = "Ammolite comes from the fossilized nacre of ammonite shells 70 million years old, found almost exclusively along the Canadian Rockies. It displays a multicolored iridescence comparable to that of opal, unique among organic gems.",
            particularites = "An organic fossil gem; a near-geographic monopoly in southern Alberta.",
            lithotherapie = "Ammolite, an organic fossil gem, is associated with luck, vitality, and positive transformation."
        ),
        ...
        "perle-conque" to GemTranslation(
            nom = "Conch pearl",
            descriptionCourte = "A flame-pink pearl without nacre, from the Caribbean queen conch.",
            descriptionLongue = "The conch pearl forms within the queen conch (Strombus gigas) of the Caribbean. Unlike classic nacreous pearls, it is non-nacreous and owes its silky luster and characteristic \"flame\" pattern to the fibrous structure of aragonite.",
            particularites = "A \"flame\" structure visible on the surface, unique to non-nacreous pearls such as the conch pearl or melo pearl.",
            lithotherapie = "The conch pearl is associated with femininity, intuition, and emotional gentleness."
        ),

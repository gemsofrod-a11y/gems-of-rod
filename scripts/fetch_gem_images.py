...
GIVE_UP_SLOTS = {
    ...
    ("onyx", BRUTE),
    ("saphir-vert", BRUTE),
    # Fossile : 3 tentatives successives (recherche + nouveaux termes x2)
    # ont échoué de façon identique sur ce créneau — soit aucun candidat
    ...
    # (les 3 autres créneaux fossiles historiquement abandonnés ici ont été
    # remis en recherche le 2026-08-23 à la demande de Gemso.)

...
GEMS = [
    ...
    ("eudialyte", ['Eudialyte'], ['eudialyte'], (BRUTE, FACETTEE)),
    ("crocoite", ['Crocoite'], ['crocoite'], (BRUTE, FACETTEE)),
    ("grenat-malaya", ['Malaya garnet', 'Malaia garnet'], ['malaya', 'garnet'], (BRUTE, FACETTEE)),
    ...
    ("tourmaline-jaune", ['Yellow tourmaline', 'Canary tourmaline'], ['tourmaline'], (BRUTE, FACETTEE)),
    ("bastnasite", ['Bastnasite', 'Bastnäsite'], ['bastnasite', 'bastnäsite'], (BRUTE, FACETTEE)),
    ("malachite", ['Malachite'], ['malachite'], (BRUTE, FACETTEE)),
    ...
    ("seraphinite", ['Seraphinite', 'Clinochlore'], ['seraphinite', 'clinochlore'], (BRUTE, FACETTEE)),
    ("grenat-grossulaire", ['Grossular garnet'], ['grossular', 'garnet'], (BRUTE, FACETTEE)),
    ("diopside", ['Chrome diopside'], ['diopside'], (BRUTE, FACETTEE)),
    ("jade-nephrite", ['Nephrite jade'], ['nephrite'], (BRUTE, FACETTEE)),
    ("maw-sit-sit", ['Maw sit sit'], ['maw sit sit', 'maw-sit-sit'], (BRUTE, FACETTEE)),
    ("tourmaline-chrome", ['Chrome tourmaline'], ['tourmaline'], (BRUTE, FACETTEE)),
    ("azurite", ['Azurite'], ['azurite'], (BRUTE, FACETTEE)),
    ("sodalite", ['Sodalite'], ['sodalite'], (BRUTE, FACETTEE)),
    ("larimar", ['Larimar', 'Blue pectolite'], ['larimar', 'pectolite'], (BRUTE, FACETTEE)),
    ("lazulite", ['Lazulite'], ['lazulite'], (BRUTE, FACETTEE)),
    ("hauyne", ['Hauyne', 'Haüyne'], ['hauyne', 'haüyne'], (BRUTE, FACETTEE)),
    ("cavansite", ['Cavansite'], ['cavansite'], (BRUTE, FACETTEE)),
    ("celestite", ['Celestite', 'Celestine mineral'], ['celestite', 'celestine'], (BRUTE, FACETTEE)),
    ("euclase", ['Euclase'], ['euclase'], (BRUTE, FACETTEE)),
    ...
    ("hemimorphite", ['Hemimorphite'], ['hemimorphite'], (BRUTE, FACETTEE)),
    ("shattuckite", ['Shattuckite'], ['shattuckite'], (BRUTE, FACETTEE)),
    ("sapphirine", ['Sapphirine gemstone', 'Sapphirine mineral'], ['sapphirine'], (BRUTE, FACETTEE)),
    ("dumortierite", ['Dumortierite'], ['dumortierite'], (BRUTE, FACETTEE)),
    ("afghanite", ['Afghanite'], ['afghanite'], (BRUTE, FACETTEE)),
    ("violane", ['Violane'], ['violane'], (BRUTE, FACETTEE)),
    ("saphir-violet", ['Purple sapphire', 'Violet sapphire'], ['sapphire'], (BRUTE, FACETTEE)),
    ("purpurite", ['Purpurite'], ['purpurite'], (BRUTE, FACETTEE)),
    ("hackmanite", ['Hackmanite'], ['hackmanite'], (BRUTE, FACETTEE)),
    ("lepidolite", ['Lepidolite'], ['lepidolite'], (BRUTE, FACETTEE)),
    ("stichtite", ['Stichtite'], ['stichtite'], (BRUTE, FACETTEE)),
    ("cobaltocalcite", ['Cobaltoan calcite', 'Cobaltocalcite'], ['cobalt', 'calcite'], (BRUTE, FACETTEE)),
    ("thulite", ['Thulite'], ['thulite'], (BRUTE, FACETTEE)),
    ("rhodonite", ['Rhodonite'], ['rhodonite'], (BRUTE, FACETTEE)),
    ("topaze-rose", ['Pink topaz'], ['topaz'], (BRUTE, FACETTEE)),
    ("quartz-rose", ['Rose quartz'], ['quartz'], (BRUTE, FACETTEE)),
    ("phosphosiderite", ['Phosphosiderite'], ['phosphosiderite'], (BRUTE, FACETTEE)),
    ("saphir-blanc", ['White sapphire', 'Colorless sapphire'], ['sapphire'], (BRUTE, FACETTEE)),
    ("topaze-blanche", ['White topaz', 'Colorless topaz'], ['topaz'], (BRUTE, FACETTEE)),
    ("hambergite", ['Hambergite'], ['hambergite'], (BRUTE, FACETTEE)),
    ("petalite", ['Petalite'], ['petalite'], (BRUTE, FACETTEE)),
    ("phenakite", ['Phenakite', 'Phenacite'], ['phenakite', 'phenacite'], (BRUTE, FACETTEE)),
    ("bytownite", ['Bytownite'], ['bytownite'], (BRUTE, FACETTEE)),
    ("hyalite", ['Hyalite opal'], ['hyalite'], (BRUTE, FACETTEE)),
    ("anhydrite", ['Anhydrite'], ['anhydrite'], (BRUTE, FACETTEE)),
    ...
    ("cerusite", ['Cerussite'], ['cerussite', 'cerusite'], (BRUTE, FACETTEE)),
    ("montebrasite", ['Montebrasite'], ['montebrasite'], (BRUTE, FACETTEE)),
    ("bois-fossilise", ['Petrified wood'], ['petrified wood'], (BRUTE, FACETTEE)),
    ("os-fossilise", ['Fossilized dinosaur bone', 'Fossil bone gembone'], ['bone', 'gembone'], (BRUTE, FACETTEE)),
    ("kornerupine", ['Kornerupine'], ['kornerupine'], (BRUTE, FACETTEE)),
    ("hyperstene", ['Hypersthene'], ['hypersthene'], (BRUTE, FACETTEE)),
    ("paesine", ['Pietra paesina', 'Paesina stone'], ['paesina', 'paesine'], (BRUTE, FACETTEE)),
    ...
    ("quartz-tourmaline", ['Tourmalinated quartz'], ['tourmalinated quartz'], (BRUTE, FACETTEE)),
    ("rubis-etoile", ['Star ruby'], ['star ruby'], (BRUTE, FACETTEE)),
    ...
    ("pietersite", ['Pietersite'], ['pietersite'], (BRUTE, FACETTEE)),
    ...
    ("quartz-a-inclusions", ['Garden quartz', 'Lodolite quartz'], ['quartz'], (BRUTE, FACETTEE)),
    ("quartz-rutile", ['Rutilated quartz'], ['rutilated quartz'], (BRUTE, FACETTEE)),
    ("quartz-super-sept", ['Super seven quartz', 'Melody stone quartz'], ['super seven', 'quartz'], (BRUTE, FACETTEE)),
    ("smithsonite", ['Smithsonite'], ['smithsonite'], (BRUTE, FACETTEE)),
    ("moldavite", ['Moldavite'], ['moldavite'], (BRUTE, FACETTEE)),
    ("verre-libyque", ['Libyan desert glass'], ['libyan desert glass'], (BRUTE, FACETTEE)),
    ("saphir-vert", ['Green sapphire'], ['sapphire'], (BRUTE, FACETTEE)),
    ("andesine", ['Andesine feldspar', 'Andesine gemstone'], ['andesine'], (BRUTE, FACETTEE)),
    ("chondrodite", ['Chondrodite'], ['chondrodite'], (BRUTE, FACETTEE)),
    ("enstatite", ['Enstatite gemstone'], ['enstatite'], (BRUTE, FACETTEE)),
    ("sphalerite", ['Sphalerite gemstone'], ['sphalerite'], (BRUTE, FACETTEE)),
    ("rutile", ['Rutile crystal', 'Rutile gemstone'], ['rutile'], (BRUTE, FACETTEE)),
    ("orthose", ['Orthoclase feldspar yellow', 'Yellow orthoclase'], ['orthoclase'], (BRUTE, FACETTEE)),
    ("corail", ['Red coral gemstone', 'Precious coral'], ['coral'], (BRUTE, FACETTEE)),
    ("perle-conque", ['Conch pearl'], ['conch pearl'], (FACETTEE,)),
]

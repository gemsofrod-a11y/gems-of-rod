...
GEMS = [
    ...
    ("tourmaline-jaune", ['Yellow tourmaline faceted', 'Yellow tourmaline', 'Canary tourmaline'], ['tourmaline'], (BRUTE, FACETTEE)),
    ...
    ("maw-sit-sit", ['Maw sit sit', 'Maw-sit-sit jade', 'Kosmochlore jadeite'], ['maw sit sit', 'maw-sit-sit', 'kosmochlore'], (BRUTE, FACETTEE)),
    ("tourmaline-chrome", ['Chrome tourmaline', 'Chrome tourmaline faceted', 'Chromium tourmaline'], ['tourmaline'], (BRUTE, FACETTEE)),
    ...
    ("violane", ['Violane diopside', 'Violane'], ['violane'], (BRUTE, FACETTEE)),
    ("saphir-violet", ['Purple sapphire faceted', 'Purple sapphire', 'Purple corundum crystal'], ['sapphire', 'corundum'], (BRUTE, FACETTEE)),
    ...
    ("saphir-blanc", ['White sapphire faceted', 'Colorless sapphire faceted', 'White sapphire gemstone'], ['sapphire'], (BRUTE, FACETTEE)),
    ("topaze-blanche", ['White topaz faceted', 'Colorless topaz faceted', 'White topaz gemstone'], ['topaz'], (BRUTE, FACETTEE)),
    ...
    ("os-fossilise", ['Dinosaur bone agate', 'Gem bone dinosaur', 'Fossilized dinosaur bone polished'], ['bone', 'gembone', 'dinosaur'], (BRUTE, FACETTEE)),
    ...
    ("quartz-tourmaline", ['Tourmalinated quartz', 'Tourmalinated quartz polished', 'Tourmalinated quartz faceted'], ['tourmalinated quartz'], (BRUTE, FACETTEE)),

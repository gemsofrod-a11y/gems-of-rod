...
function speak(text) {
  /* Dans l'app Android, MainActivity.kt expose un pont natif "AndroidTTS" qui
     utilise le moteur de synthèse vocale du système (plus fiable que le
     speechSynthesis d'une WebView, dont le support est inconsistant). */
